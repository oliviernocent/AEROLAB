...
# -*- coding: utf-8 -*-
'''
This script merges several files generated by a Light Optical Aarosol Counter (LOAC) sensor.
...
output_filename = 'LOAC_' + result['DateTime'].iloc[0][:10] + '_' + result['DateTime'].iloc[-1][:10] + '.csv'
print('Saving', output_filename)
result.to_csv(folder_name + '/' + output_filename, sep=',', index=False)
