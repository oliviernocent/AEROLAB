...
# Inserts new columns
df.insert(2, 'Date', [''] * len(df.index))
df.insert(3, 'Time', [''] * len(df.index))
df.insert(4, 'TimeNumeric', [0] * len(df.index))
df.insert(5, 'Seconds', [0] * len(df.index))
df.insert(6, 'Period', [''] * len(df.index))
